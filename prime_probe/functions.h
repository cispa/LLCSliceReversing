...
uint64_t a_0(uint64_t x)
{
    return _B(x, 6) ^ _B(x, 11) ^ _B(x, 12) ^ _B(x, 16) ^ _B(x, 18) ^ _B(x, 21) ^
           _B(x, 22) ^ _B(x, 23) ^ _B(x, 24) ^ _B(x, 26) ^ _B(x, 30) ^ _B(x, 31) ^ _B(x, 32) ^ _B(x, 35) ^ _B(x, 38);
}

uint64_t a_1(uint64_t x)
{
    return _B(x, 7) ^ _B(x, 12) ^ _B(x, 13) ^ _B(x, 17) ^ _B(x, 19) ^ _B(x, 22) ^
           _B(x, 23) ^ _B(x, 24) ^ _B(x, 25) ^ _B(x, 27) ^ _B(x, 31) ^ _B(x, 32) ^ _B(x, 33) ^ _B(x, 36);
}

uint64_t a_2(uint64_t x)
{
    return _B(x, 8) ^ _B(x, 13) ^ _B(x, 14) ^ _B(x, 18) ^ _B(x, 20) ^ _B(x, 23) ^
           _B(x, 24) ^ _B(x, 25) ^ _B(x, 26) ^ _B(x, 28) ^ _B(x, 32) ^ _B(x, 33) ^ _B(x, 34) ^ _B(x, 37);
}

uint64_t a_3(uint64_t x)
{
    return _B(x, 9) ^ _B(x, 14) ^ _B(x, 15) ^ _B(x, 19) ^ _B(x, 21) ^ _B(x, 24) ^
           _B(x, 25) ^ _B(x, 26) ^ _B(x, 27) ^ _B(x, 29) ^ _B(x, 33) ^ _B(x, 34) ^ _B(x, 35) ^ _B(x, 38);
}

uint64_t a_4(uint64_t x)
{
    return _B(x, 10) ^ _B(x, 15) ^ _B(x, 16) ^ _B(x, 20) ^ _B(x, 22) ^ _B(x, 25) ^
           _B(x, 26) ^ _B(x, 27) ^ _B(x, 28) ^ _B(x, 30) ^ _B(x, 34) ^ _B(x, 35) ^ _B(x, 36);
}

uint64_t a_5(uint64_t x)
{
    return _B(x, 11) ^ _B(x, 16) ^ _B(x, 17) ^ _B(x, 21) ^ _B(x, 23) ^ _B(x, 26) ^
           _B(x, 27) ^ _B(x, 28) ^ _B(x, 29) ^ _B(x, 31) ^ _B(x, 35) ^ _B(x, 36) ^ _B(x, 37);
}

uint64_t x_0(uint64_t x)
{
    return _B(x, 6) ^ _B(x, 8) ^ _B(x, 9) ^ _B(x, 10) ^ _B(x, 14) ^ _B(x, 15) ^
           _B(x, 17) ^ _B(x, 18) ^ _B(x, 20) ^ _B(x, 23) ^ _B(x, 27) ^ _B(x, 30) ^ _B(x, 31) ^ _B(x, 34) ^ _B(x, 36) ^ _B(x, 38);
}

uint64_t x_1(uint64_t x)
{
    return _B(x, 9) ^ _B(x, 11) ^ _B(x, 12) ^ _B(x, 13) ^ _B(x, 14) ^ _B(x, 17) ^ _B(x, 19) ^ _B(x, 21) ^ _B(x, 22) ^ _B(x, 26) ^ _B(x, 27) ^ _B(x, 29) ^ _B(x, 32);
}
...
{
    int l_0[] = {12, 14, 16, 18, 19, 20, 22, 24, 25, 27, 28, 30, 31, 32, 33, 35, 36, 38};
    int l_0_length = sizeof(l_0) / sizeof(l_0[0]);
    return eval_chain(x, l_0, l_0_length);
}
...
{
    int l_0[] = {6, 7, 8, 9, 10, 12, 13, 14, 15, 18, 19, 20, 22, 24, 25, 30, 32, 33, 34, 38};
    int l_0_length = sizeof(l_0) / sizeof(l_0[0]);
    return eval_chain(x, l_0, l_0_length);
}
...
{
    int val0 = gpu_0_chain_0(x) & gpu_extra(x);
    int val1 = gpu_0_chain_1(x) ^ val0;
    assert(val1 == 0 || val1 == 1);
    return val1;
}
...
int compute_slice_xeon(uint64_t x)
 {
    return gpu_0(x) | (gpu_1(x) << 1) | (gpu_2(x) << 2) | (gpu_3(x) << 3) | (gpu_4(x) << 4);
 }
...
{
    uint64_t val2 = (((a_2(x)) | (a_4(x)) | (a_5(x))) & ((a_2(x)) | (a_3(x))) & (a_0(x))) & 1;
...
{
    uint64_t val0 = _B(x, 6) ^ _B(x, 10) ^ _B(x, 12) ^ _B(x, 14) ^ _B(x, 16) ^ _B(x, 17) ^
                    _B(x, 18) ^ _B(x, 20) ^ _B(x, 22) ^ _B(x, 24) ^ _B(x, 25) ^ _B(x, 26) ^
                    _B(x, 27) ^ _B(x, 28) ^ _B(x, 30) ^ _B(x, 32) ^ _B(x, 33);
    uint64_t val1 = _B(x, 7) ^ _B(x, 11) ^ _B(x, 13) ^ _B(x, 15) ^ _B(x, 17) ^ _B(x, 19) ^
                    _B(x, 20) ^ _B(x, 21) ^ _B(x, 22) ^ _B(x, 23) ^ _B(x, 24) ^ _B(x, 26) ^
                    _B(x, 28) ^ _B(x, 29) ^ _B(x, 31) ^ _B(x, 33) ^ _B(x, 34);
...
int compute_slice_wiowio(uint64_t x)
{
    uint64_t val0 = _B(x, 6) ^ _B(x, 10) ^ _B(x, 12) ^ _B(x, 14) ^ _B(x, 16) ^ _B(x, 17) ^
                    _B(x, 18) ^ _B(x, 20) ^ _B(x, 22) ^ _B(x, 24) ^ _B(x, 25) ^ _B(x, 26) ^
                    _B(x, 27) ^ _B(x, 28) ^ _B(x, 30) ^ _B(x, 32);
    uint64_t val1 = _B(x, 9) ^ _B(x, 12) ^ _B(x, 16) ^ _B(x, 17) ^ _B(x, 19) ^ _B(x, 21) ^
                    _B(x, 22) ^ _B(x, 23) ^ _B(x, 25) ^ _B(x, 26) ^ _B(x, 27) ^ _B(x, 29) ^
                    _B(x, 31) ^ _B(x, 32);
    uint64_t val2 = _B(x, 10) ^ _B(x, 11) ^ _B(x, 13) ^ _B(x, 16) ^ _B(x, 17) ^ _B(x, 18) ^
                    _B(x, 19) ^ _B(x, 20) ^ _B(x, 21) ^ _B(x, 22) ^ _B(x, 27) ^ _B(x, 28) ^
                    _B(x, 30) ^ _B(x, 31);
